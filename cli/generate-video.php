...
$lockFile = fopen('/tmp/securitydrama_generate_video.lock', 'c');
if (!flock($lockFile, LOCK_EX | LOCK_NB)) {
    echo "Another video generation process is already running.\n";
    exit(1);
}

$orchestrator = new VideoOrchestrator();
$submitted = $orchestrator->submitPending();

echo "Video generation complete. Jobs submitted: {$submitted}\n";
